    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="{{url('/registroVacunados')}}">Inicio</a>
                </li>
                <li class="nav-item">
                <a class="nav-link active" href="{{url('/agregaUsuario')}}" style="text-decoration: underline">Regsitro de Usuarios</a>
                </li>
                <li class="nav-item dropdown">
                <a class="nav-link" href="{{url('/agregaVacuna')}}">Registro de Vacuna</a>
                </li>
            </ul>
            </div>
        </div>
