...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{url('/registroVacunados')}}"><h5><i class="fas fa-shield-virus"></i>Syscov</h5></a>
    ...
    <div class="containerLeft" style="float: left; width: 30%; height:650px; background-color:rgb(52, 58, 64);">
        <ul class="list-group">
            <a href="/muestraUsuario" style="color: white;"><li class="list-group-item" style="background-color:rgb(52, 58, 64);"><h4><i class="fas fa-syringe"></i> Lista de Empleados</h4></li></a>
            <a href="/muestraVacuna"  style="color: black;"><li class="list-group-item" style="background-color:white); border-top-right-radius: 25px;border-bottom-right-radius: 25px" aria-current="true"><h4><i class="fas fa-users"></i> Lista de Vacunas</h4></li></a>
        </ul>
    </div>

    <div class="containerRight" style="float: right; width: 70%; height:650px;">
    <h2 style="margin-left: 5%; margin-top: 5%"><i class="fas fa-address-book"></i> Lista de las Vacunas registradas</h2>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><h6><a href="/editar/{{$Vacuna->id}}" style="color:green;"><i class="far fa-edit"></i> Editar</a></h6></td>
                        <td><h7><a href="/borrar2/{{$Vacuna->id}}" style="color:red;"><i class="far fa-trash-alt"></i>Eliminar</a></h7></td>
